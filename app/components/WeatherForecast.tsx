  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-4">
      <MagicCard className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600 p-1">
        ...
        <div className="relative z-10 bg-zinc-900/80 backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-zinc-700/50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-4">
            {forecast.map((day, index) => (
              <MagicCard
                key={day.date}
                className="relative overflow-hidden bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 backdrop-blur-sm p-4 border border-zinc-700/50 hover:border-blue-500/50 transition-all duration-300"
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="text-xs text-zinc-400 capitalize mb-3">
