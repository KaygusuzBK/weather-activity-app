...
export default function WeatherForecast({ city, location }: WeatherForecastProps) {
  ...
  return (
    <div className="min-h-[600px] sm:h-full rounded-2xl sm:rounded-3xl p-5 sm:p-5 md:p-6 relative overflow-hidden mb-4 sm:mb-0" style={{ background: 'linear-gradient(to bottom right, #CC9C75, #D5D8B5)' }}>
      ...
      <div className="relative z-10 h-full flex flex-col">
        <h2 className="text-xl sm:text-xl md:text-2xl font-black mb-4 sm:mb-4 drop-shadow-lg shrink-0 text-center" style={{ color: '#2C2C2C' }}>
          5 Günlük Tahmin
        </h2>
        
        <div className="flex-1 flex flex-col gap-4 sm:gap-3 md:gap-3 overflow-y-auto">
          {forecast.map((day, index) => {
            ...
            return (
              <div
                key={day.date}
                className="rounded-xl sm:rounded-2xl p-4 sm:p-3 border backdrop-blur-md transition-all duration-300 shrink-0"
                style={{ 
